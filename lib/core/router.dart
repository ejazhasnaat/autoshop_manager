...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    routes: [
      GoRoute(path: '/initial-setup', builder: (context, state) => const InitialSetupScreen()),
      ...
      GoRoute(path: '/vehicles', builder: (context, state) => const SizedBox.shrink(), routes: [ GoRoute(path: 'add_draft', builder: (context, state) => const AddEditVehicleScreen(isDraftMode: true)), GoRoute(path: 'add/:customerId', builder: (context, state) => AddEditVehicleScreen(customerId: int.parse(state.pathParameters['customerId']!))), GoRoute(path: 'edit/:id', builder: (context, state) => AddEditVehicleScreen(vehicleId: int.parse(state.pathParameters['id']!), customerId: int.parse(state.uri.queryParameters['customerId']!))), GoRoute(path: ':id', builder: (context, state) => VehicleDetailScreen(vehicleId: int.parse(state.pathParameters['id']!)))]),
      ...
      GoRoute(path: '/settings/workshop', builder: (context, state) => const WorkshopSettingsScreen()),
      GoRoute(
        path: '/reminders',
        builder: (context, state) {
          final customerId = state.uri.queryParameters['customerId'];
          final fromCustomerList = state.uri.queryParameters['fromCustomerList'] == 'true';
        ...
        routes: [
          GoRoute(path: 'manage-templates', builder: (context, state) => const ManageTemplatesScreen(), routes: [ GoRoute(path: 'add', builder: (context, state) => const AddEditTemplateScreen()), GoRoute(path: 'edit', builder: (context, state) => AddEditTemplateScreen(template: state.extra as MessageTemplate))]),
          GoRoute(path: 'intervals', builder: (context, state) => const ReminderIntervalsScreen()),
        ],
      ),
    ],
  );
